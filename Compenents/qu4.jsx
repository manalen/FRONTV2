        ...
        return (
            <div>
                ...
                <div className="container-fluid cadre" style={{borderRadius:"10px",padding:"30px",marginTop: "40px",width: "700px",height:"400px",position: "absolute", left:"280px",top: "80px", marginRight: "310px",borderStyle: "ridge",borderColor: "#D7D7D7", boxShadow:"10px 10px 5px grey"}}>
                    <p>L'équipe de la clinique est constituée du Staff médical et du Staff administratif. Les médecins, secrétaires et infirmiers sont à votre disposition 24h/24 7j/7 afin de vous assurer les meilleurs soins possibles.<br/>
                    Nos médecins: "...."<br/>
                    Nos infirmiers:"..."<br/>
                    Nos secrétaires et administrateurs:"..."
                    </p>
                </div>
            </div>
        )
