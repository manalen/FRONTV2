    ...
    render(){
        return (
            <div>
                ...
                <div className="container-fluid cadre" style={{borderRadius:"10px",padding:"30px",marginTop: "40px",width: "700px",height:"200px",position: "absolute", left:"280px",top: "80px", marginRight: "310px",borderStyle: "ridge",borderColor: "#D7D7D7", boxShadow:"10px 10px 5px grey"}}>
                    <p>
                        Si vous voulez prendre un rendez-vous, il suffit de nus appeler au téléphone ou de nous rendre visite muni d'une mièce d'identité. Nous faisons en sorte que nos rendez-vous ne soient pas trop loin et qu'ils soient donc faciles à obtenir.
                    </p>
                </div>
            </div>
        )
